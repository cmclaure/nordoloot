...
export const BL = {
  ...
  "Azgalor": ["Gloves of the Forgotten Conqueror", "Gloves of the Forgotten Protector", "Gloves of the Forgotten Vanquisher", "Don Rodrigo's Poncho", "Shady Dealer's Pantaloons", "Bow of the Inferno", "Girdle of Hope", "Savage-Hewn Battleaxe", "Terrorweave Tunic", "Midnight Chestguard", "Bow-stitched Leggings", "Glory of the Defender"],
  "Archimonde": ["Tempest of Chaos", "Cataclysm's Edge", "Apostle of Argus", "Antonidas's Aegis of Rapt Concentration", "Robes of Rhonin", "Midnight Helm", "Bristleblitz Striker", "Mail of Fevered Pursuit", "Leggings of Eternity", "Scepter of Purification", "Helm of the Forgotten Conqueror", "Helm of the Forgotten Protector", "Helm of the Forgotten Vanquisher"],
