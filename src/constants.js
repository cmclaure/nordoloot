...
export const BL = {
  ...
  "Kaz'rogal": ["Kaz'rogal's Hardened Heart", "Black Featherlight Boots", "Beast-tamer's Shoulders", "Sun-touched Chain Leggings", "Blue Suede Shoes", "Angelista's Sash", "Belt of the Crescent Moon", "Belt of Seething Fury", "Leggings of Channeled Elements", "Razorfury Mantle", "Hammer of Atonement", "Valestalker Girdle"],
  "Azgalor": ["Gloves of the Forgotten Conqueror", "Gloves of the Forgotten Protector", "Gloves of the Forgotten Vanquisher", "Don Rodrigo's Poncho", "Shady Dealer's Pantaloons", "Girdle of Hope", "Boundless Agony", "Bow-stitched Leggings", "Glory of the Defender"],
  "Archimonde": ["Tempest of Chaos", "Cataclysm's Edge", "Apostle of Argus", "Antonidas's Aegis of Rapt Concentration", "Robes of Rhonin", "Midnight Chestguard", "Bristleblitz Striker", "Mail of Fevered Pursuit", "Leggings of Eternity", "Legguards of Endless Rage", "Savior's Grasp", "Scepter of Purification", "Helm of the Forgotten Conqueror", "Helm of the Forgotten Protector", "Helm of the Forgotten Vanquisher"],
...
export const MOD_DEF = {
  ...
  blp: { on: true, w: 10, label: "Bad Luck Protection", sign: "+", desc: "Each lost tie /roll-off lifts the player's future scores. Losing to a higher bid never counts — only dice losses do." },
};
